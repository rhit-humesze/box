...
def renderText(text, textcolor, textsize, outlinecolor, outlinewidth):
    ...
    def game_loop(self):
        ...
        while self.running:
            ...
            if self.game_state == 'start-screen':
                ...
                start_text = renderText("START", darkColor, 32, fontColor, 2)
                ...
                text = renderText("Box code: " + self.code, fontColor, 64, darkColor, 3)
                text_rect = text.get_rect(center=(self.WIDTH // 2, 100))
                self.screen.blit(text, text_rect)
                
                for i, player in enumerate(self.players):
                    player_text = renderText(player, fontColor, 48, darkColor, 3)
